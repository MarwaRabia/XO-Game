...
public class BoardView extends View {
    ...
    private static final int ELT_MARGIN = 10;
    private static final int ELT_STROKE_WIDTH = 10;
    private int width, height, eltW, eltH;
    private Paint gridPaint, oPaint, xPaint;
    private GameEngine gameEngine;
    private OnePlayer activity;
    ...
    public void setMainActivity(OnePlayer a) {
        activity = a;
    }
...
//
    ...
    private void drawElt(Canvas canvas, char c, int x, int y) {
        if (c == 'O') {
            ...
            canvas.drawCircle(cx, cy, Math.min(eltW, eltH) / 4 - ELT_MARGIN * 2, oPaint);
